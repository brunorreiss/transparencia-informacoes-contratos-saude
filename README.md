# Consulta Portal Transparência - Informaçoes de contratos saúde
...
```
https://github.com/brunorreiss/transparencia-informacoes-contratos-saude
```
2. Mude de diretorio:
```
cd transparencia-informacoes-contratos-saude
```
