...
logger_name = env.get('BOT_NAME', default='transparencia-informacoes-contratos-saude')
...
tags_metadata = [
    {
        ...
        'description': 'Consulta Portal Tranparencia Fortaleza - Informaçoes de contratos saúde'
    }
]
...
#---------------------------- Application -------------------------------
app = FastAPI(
    title='REST API - Consulta Portal Tranparencia Fortaleza - Informaçoes de contratos saúde', 
    description=desc, 
    debug=False, 
